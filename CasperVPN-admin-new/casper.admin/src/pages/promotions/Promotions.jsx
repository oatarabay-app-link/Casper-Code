              ...
              <tbody>
                {discounts.map((discount) => (
                  <tr key={discount.id} className="border-t border-gray-700">
                    ...
                    <td className="px-6 py-3 text-white uppercase">{discount.plan}</td>
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {modalState.type === 'discount' && (
                <>
                  ...
                  <div>
                    <label className="block text-sm text-gray-300 mb-1" htmlFor="plan">Plan</label>
                    <select
                      id="plan"
                      name="plan"
                      value={formData.plan}
