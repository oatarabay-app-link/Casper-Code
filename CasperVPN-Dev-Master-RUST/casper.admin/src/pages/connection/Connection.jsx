...
const Connection = () => {
  ...
  const { connectionStats, activeConnections } = useConnectStore();
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
         ...
         <div className="flex gap-3">
                  <button className="gap-2 px-4 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition-colors duration-200">
