...
use App\Http\Controllers\Backend\Auth\User\UsersSMTP2GOEmailDataController;
...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function () {
        ...
        Route::post('user/search/email', [UserController::class, 'search'])->name('user.search');
        ...
        Route::group(['prefix' => 'user/{user}'], function () {
            ...
            Route::get('/subscriptions', [UserController::class, 'show_subscriptions'])->name('user.subscriptions');
            ...
            // User Extemsions
            Route::resource('/user-subscription-extensions', 'UserSubscriptionExtensionsController');

            // User Servers
            Route::resource('/user-servers', 'UserServerController');
            // User Radius Attributes
            Route::resource('/user-radius-attributes', 'UserRadiusAttributesController');
            // User History
            Route::resource('/user-history', 'UserHistoryController');
            // User Radius Logs
            Route::resource('/user-rad-acct', 'UserRadAcctController');
            //Conn Log SSH
            Route::resource('/user-conn-log', 'UserConnLogController');
            // User payments check
            Route::resource('/user-payments-check', 'UserPaymentsCheckController');
            // User Payment Logs
            Route::resource('/user-payments-logs', 'UserPaymentsController');
            // User email Logs
            Route::resource('/user-email-logs', 'UsersSMTP2GOEmailDataController');
