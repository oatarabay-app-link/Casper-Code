...
{{--    <input class="form-control" name="user_id" type="hidden" id="user_id" value="{{ isset($usersubscriptionextension->user_id) ? $usersubscriptionextension->user_id : $user->id}}" >--}}
...
{{--    <input class="form-control" name="subscription_id" type="hidden" id="subscription_id" value="{{ isset($usersubscriptionextension->subscription_id) ? $usersubscriptionextension->subscription_id : $user->subscription->id}}" >--}}
...
<div class="form-group {{ $errors->has('exipry_date') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="exipry_date" type="hidden" id="exipry_date" value="{{ isset($usersubscriptionextension->expiry_date) ? $usersubscriptionextension->expiry_date : ''}}" >
