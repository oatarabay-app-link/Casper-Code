                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Uuid</th><th>Subscription Uuid</th><th>Subscription Id</th><th>User Id</th><th>Period In Months</th><th>Payment Id</th><th>Status</th><th>Payment Sum</th><th>Details</th><th>Check Code</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($payments as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->uuid }}</td><td>{{ $item->subscription_uuid }}</td><td>{{ $item->subscription_id }}</td><td>{{ $item->user_id }}</td><td>{{ $item->period_in_months }}</td><td>{{ $item->payment_id }}</td><td>{{ $item->status }}</td><td>{{ $item->payment_sum }}</td><td>{{ $item->details }}</td><td>{{ $item->check_code }}</td>
                                        <td>
