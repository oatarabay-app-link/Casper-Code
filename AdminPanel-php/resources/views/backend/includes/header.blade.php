<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/backend/brand/logo.png') }}" width="125" height="32"
             alt="CoreUI Logo">
...
{{--            <form class="form-horizontal" action="/admin/auth/user/search/email" method="post">--}}
            <form class="form-horizontal" action="/admin/auth/user/search/email" method="post">
                <div class="input-group">
                    <input class="form-control" id="input1-group2" type="text" name="email"
