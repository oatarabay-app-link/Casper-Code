...
{{--                                <th>@lang('labels.general.actions')</th>--}}
                            ...
                            <tbody>
                                                        @foreach($users as $user)
                                                            <tr>
                                                                <td><a href="/admin/auth/user/{!! $user->user_id !!}" >{{ $user->email }}</a></td>
                                                                <td>{{ $user->status }}</td>
                                                                <td>{{ $user->signup_date }}</td>
                                                                <td>{{ $user->signedin_date }}</td>
                                                                <td>{{ $user->subscription }}</td>
                                                                <td><a href="/admin/auth/user/{!! $user->user_id !!}/user-email-logs"> {{ $user->emails_sent }} </a></td>

                                                                <td><a href="/admin/auth/user/{!! $user->user_id !!}/user-email-logs"> {{ $user->emails_problems }} </a></td>
                                                                <td>{{ $user->device }}</td>
                                                                <td>{{ $user->country }}</td>
                                                                <td>{{ $user->OS }}</td>
