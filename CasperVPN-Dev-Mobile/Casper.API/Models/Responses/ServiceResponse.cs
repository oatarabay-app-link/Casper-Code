namespace Casper.API.Models.Responses
{
    ...
    //    // Fixed: Now properly generic
    //    public static ServiceResponse<T> Success(T data, string message = "Success", PaginationInfo? pagination = null)
    //    {
    ...
    //    public static ServiceResponse<T> Error(string message, int status = 500, T? data = default)
    //    {
    //        return new ServiceResponse<T>
    //        {
    //            Status = status,
    ...
    //    public static ServiceResponse<T> BadRequest(string message = "Bad request", T? data = default)
    //        => new() { Status = 400, Message = message, Data = data };

    //    public static ServiceResponse<T> NotFound(string message = "Resource not found", T? data = default)
    //        => new() { Status = 404, Message = message, Data = data };

    //    // Add this inside your ServiceResponse<T> class
    //    public static ServiceResponse<T> Conflict(string message, T? data = default)
    //    {
    //        return new ServiceResponse<T>
    //        {
    //            Status = 409,
