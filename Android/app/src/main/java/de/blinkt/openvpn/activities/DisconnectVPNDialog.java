...
public class DisconnectVPNDialog extends Activity implements DialogInterface.OnClickListener, DialogInterface.OnCancelListener {
    private IOpenVPNServiceInternal mService;
    private Commun commun = new Commun(this);
