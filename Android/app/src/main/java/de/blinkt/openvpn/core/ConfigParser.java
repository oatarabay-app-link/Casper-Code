...
public class ConfigParser {
    ...
    public VpnProfile convertProfile(VpnProfile Profile) throws ConfigParseError, IOException {
        boolean noauthtypeset = true;
        VpnProfile np = Profile;
        if (np == null) np = new VpnProfile(CONVERTED_PROFILE);
