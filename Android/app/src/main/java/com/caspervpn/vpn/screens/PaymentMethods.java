...
public class PaymentMethods extends Activity implements View.OnClickListener, IabBroadcastListener
{
    Activity MyActivity;
    Commun commun;
    ...
    private void Init()
    {
        ...
        Fortumo= (ImageView) findViewById(R.id.Fortumo);
        BTC = (ImageView) findViewById(R.id.BTC);

        GooglePlay.setOnClickListener(this);
        BTC.setOnClickListener(this);
        Fortumo.setOnClickListener(this);
//
